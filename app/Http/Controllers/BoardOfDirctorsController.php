...
class BoardOfDirctorsController extends Controller
{
     ...
     */
    public function show(BoardOfDirctor $boardOfDirctor)
    {
        return response()->json([
            'status' => true,
     ...
     */
    public function update(Request $request, BoardOfDirctor $boardOfDirctor)
    {
        $request->validate([
            'name' => 'required|string',
            'position' => 'required|string',
     ...
     */
    public function destroy(BoardOfDirctor $boardOfDirctor)
    {
